/*
=======================================================================
Stored Pocedure : Load Bronze Layer (Source -> Bronze)
=======================================================================
Script Purpose : 
        This stored procedure loads that are in the 'bronze' schema from external CSV file.
        It performs the following action :
         - Trunkcates the Bronze table before loading data.
...
BEGIN
	...
	BEGIN TRY 
		...
		-- Adding Data into bronze tables 
